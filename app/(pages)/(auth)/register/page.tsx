...
export default function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[#0B0F19] px-4 overflow-hidden font-sans">
      ...
      <div className="absolute top-[-20%] right-[-10%] w-[500px] h-[500px] rounded-full bg-gradient-to-tr from-indigo-600/20 to-purple-600/20 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-20%] left-[-10%] w-[500px] h-[500px] rounded-full bg-gradient-to-br from-blue-600/20 to-emerald-600/20 blur-[120px] pointer-events-none" />
      ...
      <div className="w-full max-w-md p-8 md:p-10 rounded-2xl bg-[#161B26]/60 border border-gray-800 backdrop-blur-xl shadow-2xl z-10 transition-all duration-300">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-400">Create your LAPOR.IN account today</p>
        </div>
