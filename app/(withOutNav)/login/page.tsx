...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        setError(result.error || "Email atau kata sandi tidak valid.");
      } else {
        ...
        <div className="w-full max-w-[440px] flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <h1 className="text-4xl font-bold text-black leading-tight tracking-tight">
              Selamat Datang<br />
              <span className="text-neutral-400">Kembali.</span>
            </h1>
            <p className="text-sm text-neutral-500 leading-relaxed">
              Masuk untuk melanjutkan menilai dan memantau kondisi infrastruktur kotamu.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link href="/resetpassword" className="text-xs text-neutral-500 hover:text-black transition-colors duration-150">
                  Lupa kata sandi?
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-xs text-neutral-500">
            Belum punya akun?{" "}
            <Link href="/register" className="text-black font-semibold hover:underline underline-offset-2 transition-colors duration-150">
              Daftar sekarang
            </Link>
          </p>
        </div>
